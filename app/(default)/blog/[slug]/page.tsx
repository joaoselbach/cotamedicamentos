          ...
          <div className="max-w-3xl">
            <article>
              ...
              <header className="pb-8">
                <div className="mb-6">
                  <Link
                    className="text-sm font-medium text-[#01b1bc] transition-colors hover:text-[#009ba5]"
                    href="/"
                  >
