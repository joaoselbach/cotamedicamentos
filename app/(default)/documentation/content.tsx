  ...
  return (
    <div className="md:grow">
      ...
      <div className="text-lg text-gray-600">
        <h2 className="h2 text-gray-900 mb-4">Introduction</h2>
        <p className="mb-8">
        ...
        <p className="flex items-center text-base px-3 py-4 text-gray-800 bg-blue-100 border border-blue-200 rounded mb-8">
          <svg className="w-4 h-4 fill-current text-[#01b1bc] shrink-0 mr-2" xmlns="http://www.w3.org/2000/svg">
          ...
          <span>Check out the <a className="text-[#009ba5] hover:underline" href="#0">Terms and license page</a> to know more about our license.</span>
        </p>
        ...
        <p className="flex items-center text-base px-3 py-4 text-gray-800 bg-blue-100 border border-blue-200 rounded mb-8">
          ...
          <span>Learn more about <a className="text-[#009ba5] hover:underline" href="#0">Customising settings</a>.</span>
        </p>
      ...
      <div className="mt-8">
        ...
        <a className="flex justify-between items-center p-4 rounded border border-gray-200 transition duration-300 ease-in-out bg-white shadow-md hover:shadow-lg mb-4" href="#0">
          ...
          <svg className="w-4 h-4 fill-current text-[#009ba5] shrink-0 ml-6" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
