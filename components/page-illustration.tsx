  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-[#01b1bc] opacity-50 blur-[160px] will-change-[filter]" />
      </div>
      {/* <div
        className="pointer-events-none absolute left-1/2 top-[420px] ml-[380px] -translate-x-1/2"
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-[#01b1bc] to-gray-900 opacity-50 blur-[160px] will-change-[filter]" />
      </div> */}
      {/* <div
